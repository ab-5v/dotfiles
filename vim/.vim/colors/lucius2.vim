...
hi Character        ctermfg=138                                     cterm=none
" numbers decimal/hex
...
hi Function         ctermfg=151                                     cterm=none


" == Statements ==
" any statement
hi Statement        guifg=#b3d38c                                   gui=none
hi Statement        ctermfg=151                                     cterm=none
" if, then, else
hi Conditional      guifg=#b3d38c                                   gui=none
hi Conditional      ctermfg=151                                     cterm=none
" try, catch, throw, raise
hi Exception        guifg=#b3d38c                                   gui=none
hi Exception        ctermfg=151                                     cterm=none
" for, while, do
hi Repeat           guifg=#b3d38c                                   gui=none
hi Repeat           ctermfg=151                                     cterm=none
" case, default
...
hi StatusLine       ctermfg=245             ctermbg=237             cterm=none
...
hi jsDocType              ctermfg=240         cterm=none
hi jsDocTypeNoParam       ctermfg=240         cterm=none
hi jsDocParam             ctermfg=240         cterm=none
hi jsRegexpString         ctermfg=9         cterm=none
hi jsRegexpBoundary       ctermfg=9         cterm=none
hi jsRegexpQuantifier     ctermfg=9         cterm=none
hi jsRegexpOr             ctermfg=9         cterm=none
hi jsRegexpMod            ctermfg=9         cterm=none
hi jsRegexpBackRef        ctermfg=9         cterm=none
hi jsRegexpGroup          ctermfg=9         cterm=none
hi jsRegexpCharClass      ctermfg=9         cterm=none

hi jsPrototype            ctermfg=151        cterm=none
hi jsArguments            ctermfg=151       cterm=none
hi jsThis                 ctermfg=151        cterm=none

hi jsReturn               ctermfg=151         cterm=none
hi jsType                 ctermfg=151       cterm=none

hi jsNull                 ctermfg=109         cterm=none
hi jsUndefined            ctermfg=109         cterm=none
...
hi jsLabel                ctermfg=fg         cterm=none

hi jsSpecial              ctermfg=9         cterm=none
hi jsSource               ctermfg=9         cterm=none
hi jsCommonJS             ctermfg=151         cterm=none
hi jsFutureKeys           ctermfg=9         cterm=none
